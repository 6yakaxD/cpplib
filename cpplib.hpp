/*************************************************************************************\
*  Author:												 Title:						  *
*   ______     ______     __    __     __     __         this is c++ lib for personal *
*  /\  == \   /\  __ \   /\ "-./  \   /\ \   /\ \        use, not for commercial	  *
*  \ \  __<   \ \  __ \  \ \ \-./\ \  \ \ \  \ \ \____   purposes 					  *
*   \ \_\ \_\  \ \_\ \_\  \ \_\ \ \_\  \ \_\  \ \_____\	 Version:	beta			  *
*    \/_/ /_/   \/_/\/_/   \/_/  \/_/   \/_/   \/_____/  Copyrgiht: 2023			  *
*																					  *
\*************************************************************************************/
#pragma once
...
namespace cpplib
{
	...
	*/
	...
	void hide_console() 
	{
		...
		ShowWindow(FindWindowA("ConsoleWindowClass", NULL), 1); // 0 -> консоль спр€тана
		*/
		ShowWindow(FindWindowA("ConsoleWindowClass", NULL), 0); // 0 -> консоль спр€тана 
	}
