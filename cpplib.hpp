...
namespace cpplib
{
	...
	*/
	...
	int get_ProcessorName() {
		...
		// Получение указателя на пространство имен WMI
		...
		// Установка безопасности на сервисе WMI
		...
		// Выполнение запроса WMI для получения информации о процессоре
		...
		// Получение данных из запроса WMI
