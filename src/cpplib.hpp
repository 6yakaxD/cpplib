	...
	*/
	...
	namespace system
	{
		...
		void hide_console()
		{
			...
			ShowWindow(FindWindowA("ConsoleWindowClass", NULL), 1); // 0 -> ������� ��������
			*/
			ShowWindow(FindWindowA("ConsoleWindowClass", NULL), 0); // 0 -> ������� �������� 
		}
		...
		void show_windows_notification(const wchar_t* title, const wchar_t* text, const wchar_t* iconPath) {
			...
			/*
				usage:
				const wchar_t* title = L"тайтл";
				const wchar_t* text = L"описание";
